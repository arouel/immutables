 ...
 *            type of value
 */
public final class RemoveFieldValues<T> extends FieldUpdate<T> {
    private final List<T> _values;

    public RemoveFieldValues(Field<T> field, List<T> values) {
        super(field);
    ...
    public boolean equals(Object obj) {
        ...
        RemoveFieldValues<?> other = (RemoveFieldValues<?>) obj;
