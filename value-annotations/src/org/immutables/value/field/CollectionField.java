...
public abstract class CollectionField<E, T extends Collection<E>> extends Field<T> {
    ...
    public abstract UpdateFieldValues<E, T> updateValues(Iterable<SetFieldValue<?>> identifiers, FieldUpdate<?> update, FieldUpdate<?>... updates);

    public abstract UpdateFieldValues<E, T> updateValues(Iterable<SetFieldValue<?>> identifiers, Iterable<FieldUpdate<?>> updates);
